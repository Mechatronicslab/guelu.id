    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand" href="/admin"><img src="{{URL::to('/')}}/images/icon.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="/admin"><img src="{{URL::to('/')}}/images/favicon.png" alt="Logo"></a>
