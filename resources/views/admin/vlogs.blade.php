            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8">
                    <div class="card">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.UpdateVlogs', $post) }}">
                        {{ csrf_field(  ) }}
                        {{ method_field('patch') }}
                        <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="title" value="{{ $post->title }}" placeholder="Judul konten..." required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="content" value="{{ $post->content }}" placeholder="URL embed..." required>
                                    </div>
                                </div>
