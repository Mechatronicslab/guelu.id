            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form method="post" enctype="multipart/form-data"
                                  action="{{ route('admin.InsertKategori') }}">
                                {{ csrf_field() }}
                ...
                <div class="col-xs-6 col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Kategori yang dimasukan akan bersifat sama untuk setiap postingan, baik forum, vidoe blog
                                atau berita.</p>
                            <p>Silahkan isikan nama kategori sesuai ketentuan yang berlaku, isikan juga deskripsi dari
                                masing masing kategori untuk mempermudah penggunaan.</p>
                        </div>
                    </div>
                </div>
            </div>
