    ...
    <div class="home">
        ...
        <div class="home_slider_container">
            <div class="owl-carousel owl-theme home_slider">
                                ...
                                <div class="col">
                                    <div class="home_slider_content">
                                        ...
                                        <div class="home_slider_item_title">
                                            <a href="/post">Tittle Content Sample Tranding Post #1</a>
                                        </div>
                ...
                <!-- Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url({{URL::to('/')}}/images/slider_home_2.jpg)"></div>
                    <div class="home_slider_content_container">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="home_slider_content">
                                        <div class="home_slider_item_category trans_200"><a href="category.html" class="trans_200">Category</a></div>
                                        <div class="home_slider_item_title">
                                            <a href="/post">Tittle Content Sample Tranding Post #2</a>
                                        </div>
                                        <div class="home_slider_item_link">
                                            <a href="/post" class="trans_200">Continue Reading
                                                <svg version="1.1" id="link_arrow_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="similar_posts_container">
                        <div class="container">
                            <div class="row d-flex flex-row align-items-end">
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #4</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #5</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #6</a>
                                    </div>
                                </div>
                        ...
                        <div class="home_slider_next_container">
                            <div class="home_slider_next" style="background-image:url({{URL::to('/')}}/images/pager.jpg)">
                                ...
                                <div class="home_slider_next_content trans_400">
                                    <div class="home_slider_next_title">next</div>
                                    <div class="home_slider_next_link">Title Content Tranding #2</div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url({{URL::to('/')}}/images/slider_home_3.jpg)"></div>
                    <div class="home_slider_content_container">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="home_slider_content">
                                        <div class="home_slider_item_category trans_200"><a href="category.html" class="trans_200">Category</a></div>
                                        <div class="home_slider_item_title">
                                            <a href="/post">Tittle Content Sample Tranding Post #3</a>
                                        </div>
                                        <div class="home_slider_item_link">
                                            <a href="/post" class="trans_200">Continue Reading
                                                <svg version="1.1" id="link_arrow_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="similar_posts_container">
                        <div class="container">
                            <div class="row d-flex flex-row align-items-end">
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #7</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #8</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 similar_post_col">
                                    <div class="similar_post trans_200">
                                        <a href="/post">Title Content Tranding #9</a>
                                    </div>
                                </div>
                        ...
                        <div class="home_slider_next_container">
                            <div class="home_slider_next" style="background-image:url({{URL::to('/')}}/images/pager.jpg)">
                                ...
                                <div class="home_slider_next_content trans_400">
                                    <div class="home_slider_next_title">next</div>
                                    <div class="home_slider_next_link">Title Content Tranding #3</div>
                                </div>
                            </div>
                        </div>
