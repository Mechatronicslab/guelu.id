                                ...
                                <div class="grid clearfix">
                                    <div class="card card_default card_small_with_background grid-item">
                                        <div class="card_background"
                                             style="background-image:url({{URL::to('/')}}/images/post_11.jpg)"></div>
                                        <div class="card-body">
                                            <div class="card-title card-title-small"><a href="/post">How Did van Gogh’s
                                    ...
                                    <div class="card card_default card_small_with_background grid-item">
                                        <div class="card_background"
                                             style="background-image:url({{URL::to('/')}}/images/post_16.jpg)"></div>
                                        <div class="card-body">
                                            <div class="card-title card-title-small"><a href="/post">How Did van Gogh’s
                                                    Turbulent Mind Depict One of the Most Complex Concepts in
                                                    Physics?</a></div>
