                                        ...
                                        <div class="col-lg-11">
                                            ...
                                            <div class="post_comment">
                                                <div class="contact_form_container">
                                                    <form action="#">
                                                        <input type="text" class="contact_input contact_input_name" placeholder="Nama depan" required="required">
                                                        <input type="text" class="contact_input contact_input_name" placeholder="Nama belakang" required="required">
                                                        <input type="text" class="contact_text" placeholder="Nama lengkap" required="required">
                                                        <input type="text" class="contact_text" placeholder="Alamat email" required="required">
                                                        <input type="text" class="contact_text" placeholder="Username" required="required">
